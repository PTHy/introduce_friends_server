...
public enum ResponseType {
    ...
    REGISTER_USER_SUCCESS(202, "유저 회원가입에 성공하였습니다"),
    LOGIN_USER_SUCCESS(203, "유저 로그인에 성공하였습니다"),
    MODIFY_USER_SUCCESS(204, "유저 정보 수정에 성공하였습니다"),
    DELETE_USER_SUCCESS(205, "회원 탈퇴에 성공하였습니다");
